        ...
        private void addevent() {
            btnthoatkhkt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(Showkhkt.this,Chontheloai.class);
    ...
    public void showAlertDialog(final int pos){
        ...
        builder.setNegativeButton("Cập nhật", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent intent=new Intent(Showkhkt.this, Updatekhkt.class);
                Bundle ten=new Bundle();
                ten.putSerializable("khau",sachArrayList.get(pos));
